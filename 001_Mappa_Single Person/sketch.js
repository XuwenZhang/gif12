...
function preload() {
  ...
  secondPath = loadTable('Sakeena_track_points.csv', 'csv', 'header');
  thirdPath = loadTable('Xuwen_track_points.csv', 'csv', 'header');
  fourthPath = loadTable('Fire.csv', 'csv', 'header');
}
...
function setup() {
  ...
  myMap.onChange(drawPathFire.bind(null, fourthPath));
}
